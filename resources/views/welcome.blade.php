...
<div class="container">
    ...
    <div class="blog-header">
        ...
        <p class="lead blog-description">The official template of creating a Jokes blog with Bootstrap.</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            ...
            <div class="blog-post">
                <h2 class="blog-post-title">Another Joke post</h2>
            ...
            <div class="blog-post">
                <h2 class="blog-post-title">Joke post 3</h2>
